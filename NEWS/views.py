...
class EditCommentView(View):
    def get(self, request, comment_id):
        ...
        return render(request, 'edit_item.html', {'form': form, 'commented': False})
    ...
    def post(self, request, comment_id, *args, **kwargs):
        ...
        if comment_form.is_valid():
            ...
            return render(request, 'edit_item.html', {'form': comment_form, 'commented': False})
...
class DeleteCommentView(View):
    def get(self, request, comment_id):
        ...
        return render(request, 'delete_item.html', {'comment': comment})
